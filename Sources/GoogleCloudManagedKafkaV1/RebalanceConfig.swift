...
public struct RebalanceConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Optional. The rebalance behavior for the cluster.
  /// When not specified, defaults to `NO_REBALANCE`.
  public var mode: RebalanceConfig.Mode = RebalanceConfig.Mode()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `RebalanceConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RebalanceConfig().with { $0.mode = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(RebalanceConfig.Mode.self, forKey: .mode) {
      self.mode = value
    }
  ...
  public enum Mode: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .noRebalance: return 1
      case .autoRebalanceOnScaleUp: return 2
    ...
    public var stringValue: Swift.String? {
      ...
      case .noRebalance: return "NO_REBALANCE"
      case .autoRebalanceOnScaleUp: return "AUTO_REBALANCE_ON_SCALE_UP"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "NO_REBALANCE": self = .noRebalance
      case "AUTO_REBALANCE_ON_SCALE_UP": self = .autoRebalanceOnScaleUp
    ...
    public init(intValue: Int) {
      ...
      case 1: self = .noRebalance
      case 2: self = .autoRebalanceOnScaleUp
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.managedkafka.v1.RebalanceConfig"
  }
