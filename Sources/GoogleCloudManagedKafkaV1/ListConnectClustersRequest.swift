...
public struct ListConnectClustersRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListConnectClustersRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListConnectClustersRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.managedkafka.v1.ListConnectClustersRequest"
  }
