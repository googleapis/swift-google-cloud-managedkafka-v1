...
public struct ListTopicsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListTopicsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTopicsResponse().with { $0.topics = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.managedkafka.v1.ListTopicsResponse"
  }
...
extension ListTopicsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Topic] {
    return self.topics
  }
