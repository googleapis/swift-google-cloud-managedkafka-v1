...
public struct ListConnectorsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListConnectorsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListConnectorsResponse().with { $0.connectors = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Connector].self, forKey: .connectors) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.managedkafka.v1.ListConnectorsResponse"
  }
