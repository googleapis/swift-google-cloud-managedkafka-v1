...
public struct ListConnectorsRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListConnectorsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListConnectorsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.managedkafka.v1.ListConnectorsRequest"
  }
