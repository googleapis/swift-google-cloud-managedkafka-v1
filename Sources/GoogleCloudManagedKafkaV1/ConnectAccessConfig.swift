...
public struct ConnectAccessConfig: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  /// Required.
  ...
  ///
  /// ```
  /// let value = ConnectAccessConfig().with { $0.networkConfigs = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.managedkafka.v1.ConnectAccessConfig"
  }
