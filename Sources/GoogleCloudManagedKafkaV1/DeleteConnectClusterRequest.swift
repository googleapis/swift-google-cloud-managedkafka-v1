...
public struct DeleteConnectClusterRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteConnectClusterRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteConnectClusterRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.managedkafka.v1.DeleteConnectClusterRequest"
  }
