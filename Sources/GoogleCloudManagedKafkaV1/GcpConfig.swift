...
/// Platform.
public struct GcpConfig: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GcpConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GcpConfig().with { $0.accessConfig = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.managedkafka.v1.GcpConfig"
  }
